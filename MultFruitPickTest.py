# Pick multiple fruit, do not deliver, do not ignore
...
Vision3 = Vision (Ports.PORT9, 50, Vision16__LIMEFRUIT, Vision16__LEMONFRUIT, Vision16__ORANGEFRUIT)
...
def cameraTimerCallback():
    ...
    gobjects = Vision3.take_snapshot(Vision16__LIMEFRUIT)
    yobjects = Vision3.take_snapshot(Vision16__LEMONFRUIT)
    oobjects = Vision3.take_snapshot(Vision16__ORANGEFRUIT)
