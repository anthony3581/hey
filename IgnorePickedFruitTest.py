...
Vision9__LIMEFRUIT = Signature (1, -6291, -5615, -5953, -3457, -2907, -3182, 3, 0)
Vision9__LEMONFRUIT = Signature (2, 1785, 4213, 2999, -4201, -3863, -4032, 3, 0)
Vision9__ORANGEFRUIT = Signature (3, 5231, 8313, 6772, -3049, -2703, -2876, 3, 0)
...
FruitsLeft = ["ORANGE", "YELLOW", "GREEN"]
def cameraTimerCallback():
    ...
    # if gobjects and "ORANGE" in FruitsLeft and w > 20 and h> 20:
    #     print("GREEN FRUIT FOUND")
    #     handleObjectDetection()
    # elif yobjects and "YELLOW" in FruitsLeft and w > 20 and h> 20:
    #     print("YELLO FRUIT FOUND")
    #     handleObjectDetection()
    # elif oobjects and "ORANGE" in FruitsLeft and w > 20 and h> 20:
    #     print ("ORANGE OBJECT DETECTED")
    #     handleObjectDetection()
    # else: missedDetections = missedDetections + 1
    if (gobjects and "GREEN" in FruitsLeft) or (yobjects and "YELLOW" in FruitsLeft) or (oobjects and "ORANGE" in FruitsLeft): 
        if "YELLOW" in FruitsLeft:
